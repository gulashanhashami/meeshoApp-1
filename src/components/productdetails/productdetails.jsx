        ...
        <div className='complete_page'>
                <div className='left_side'>
                    <div className='left_small'>
                            ...
                            <img  src="https://images.meesho.com/images/products/33994741/qxnyk_64.jpg"/>
                        
                    </div>
                    <div className='left_big'>
                        <div className='left_big_img'>
                            <img src="https://images.meesho.com/images/products/33994741/qbnid_512.jpg" />
                        </div>
                        <div className='left_big_p'>
                            <button className='Add_to_card'>Add To Cart</button>
                            <hr />
                            <p>1 Similar Products</p>
                            <img className='small_image' src="https://images.meesho.com/images/products/33994741/qbnid_512.jpg" />
                        </div>
                    </div>
                </div>
